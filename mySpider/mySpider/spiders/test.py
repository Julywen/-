...
class ItcastSpider(scrapy.Spider):
    ...
    url = "https://sclub.jd.com/comment/productPageComments.action?callback=fetchJSON_comment98vv165&productId=100002997682&score=0&sortType=5&page=1&pageSize=10&isShadowSku=0&rid=0&fold=1"
    ...
    def parse(self, response):
        ...
        for line in jsonobj["comments"]:
            ...
            userClientShow = line["userClientShow"]
            content = line["content"]
            referenceName = line["referenceName"]

            print("%s\t%s\t%s\t%s\t%s\t%s" % (id, score, nickname, userClientShow, content, referenceName))
